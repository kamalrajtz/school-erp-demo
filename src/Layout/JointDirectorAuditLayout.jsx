...
import JointDirectorAuditRoutes from '../Routes/JointDirectorAuditRoutes'

const JointDirectorAuditLayout = () => {
...
export default JointDirectorAuditLayout
