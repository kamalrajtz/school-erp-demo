...
import StationeryStoreManagerRoutes from '../Routes/StationeryStoreManagerRoutes'

const StationeryStoreManagerLayout = () => {
...
export default StationeryStoreManagerLayout
