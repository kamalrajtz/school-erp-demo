...
import HousekeepingManagerRoutes from '../Routes/HousekeepingManagerRoutes'

const HousekeepingManagerLayout = () => {
...
export default HousekeepingManagerLayout
