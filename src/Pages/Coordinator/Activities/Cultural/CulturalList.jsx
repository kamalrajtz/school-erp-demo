        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Cultural List</h2>
                    <div className='flex gap-x-2'>
                        <NavLink to="/coordinator/activities/cultural/add" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Classical Dance</td>
                                <td className="px-2 py-4">Annual Day</td>
                                <td className="px-2 py-4">All Students</td>
                                ...
                                <td className="px-2 py-4">Ms. Priya</td>
                                <td className="px-2 py-4">Traditional dance performance by students</td>
