        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Competitions List</h2>
                    <div className='flex gap-x-2'>
                        <NavLink to="/coordinator/activities/competitions/add" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Add New Competition
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Competitions Name</th>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Coordinator</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Quiz Competition</td>
                                <td className="px-2 py-4">Academic</td>
                                <td className="px-2 py-4">9 - A vs 9 - B</td>
                                <td className="px-2 py-4">15-08-2025</td>
                                <td className="px-2 py-4">10:00 AM</td>
                                <td className="px-2 py-4">11:30 AM</td>
                                <td className="px-2 py-4">School Auditorium</td>
                                <td className="px-2 py-4">Mr. Kumar</td>
                                <td className="px-2 py-4">Team-based quiz, no mobile phones allowed</td>
