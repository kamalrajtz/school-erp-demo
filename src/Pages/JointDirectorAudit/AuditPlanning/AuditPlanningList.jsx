        ...
        <section>
            <div className='bg-white rounded-2xl shadow-md p-4'>
                <p className='text-sm text-[#667085] mb-4'>
                    Create and schedule audits across departments. Track planned, in-progress, and completed audit cycles.
                </p>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:mt-8 mt-2'>
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <input type='text' id='search' placeholder='Audit ID, title...' className='text-sm font-normal text-[#808080] border border-[#D9D9D9] rounded-md px-2 py-2 w-full' />
                    </div>
                    <div className='flex flex-col gap-y-2'>
                        <label htmlFor='audit-type' className='text-base font-medium text-[#808080]'>Audit Type</label>
                        <select id='audit-type' className='text-sm font-normal text-[#808080] border border-[#D9D9D9] rounded-md px-2 py-2 w-full'>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Audit Planning List</h2>
                    <div className='flex gap-x-2'>
                        <NavLink
                            to='/joint-director-audit/audit-planning/add-audit-plan'
                    ...
                    <table className='w-full text-sm text-left rtl:text-right'>
                        <thead className='text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg'>
                            <tr>
                                ...
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Audit Type</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Department</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Assigned Auditor</th>
                        ...
                        <tbody>
                            {AUDIT_PLANS.map((plan) => (
                                <tr key={plan.id} className='border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7]'>
                                    <td className='px-2 py-4 font-medium text-[#1E1E1E] rounded-s-lg'>{plan.id}</td>
                                    <td className='px-2 py-4 max-w-[180px] truncate' title={plan.title}>{plan.title}</td>
                                    <td className='px-2 py-4'>
                                        <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${auditTypeBadgeColor[plan.auditType]}`}>
                                            {plan.auditType.replace(' Audit', '')}
                                        </span>
                                    </td>
                                    <td className='px-2 py-4'>{plan.department}</td>
                                    <td className='px-2 py-4'>{plan.assignedAuditor}</td>
                                    <td className='px-2 py-4'>
                                        <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${priorityBadgeColor[plan.priority]}`}>
                                            {plan.priority}
                                        </span>
                                    </td>
                                    <td className='px-2 py-4 whitespace-nowrap'>{plan.scheduledDate}</td>
                                    <td className='px-2 py-4'>
                                        <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${statusBadgeColor[plan.status]}`}>
                                            {plan.status}
                                        </span>
                                    </td>
                                    <td className='px-2 py-4 text-center rounded-e-lg'>
                                        <Dropdown buttonContent={<EllipsisIcon size={16} className='text-black' />}>
                                            <NavLink
                                                to={`/joint-director-audit/audit-planning/view/${plan.id}`}
                                                className='block w-full text-left p-2 hover:bg-[#515DEF] hover:text-white rounded cursor-pointer'
                                            >
                                                View
                                            </NavLink>
                                            <NavLink
                                                to={`/joint-director-audit/audit-planning/edit/${plan.id}`}
                                                className='block w-full text-left p-2 hover:bg-[#515DEF] hover:text-white rounded cursor-pointer'
                                            >
                                                Edit
                                            </NavLink>
            ...
            <div className='flex justify-between items-center px-4 mt-4'>
                <p className='text-sm font-medium text-[#515DEF]'>Showing 1 to {AUDIT_PLANS.length} of {AUDIT_PLANS.length} entries</p>
...
export default AuditPlanningList
