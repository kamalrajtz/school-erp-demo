        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Holiday Notifications List</h2>
                </div>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Holiday Name</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Holiday Type</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Pongal Holidays</td>
                                <td className="px-2 py-4">Festival</td>
                                <td className="px-2 py-4">14-01-2026</td>
                                <td className="px-2 py-4">17-01-2026</td>
                                <td className="px-2 py-4 rounded-e-lg">School will remain closed for Pongal celebrations.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
