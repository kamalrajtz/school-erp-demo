        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Exam Notifications List</h2>
                </div>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Notification Title</th>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Room</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Message</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-e-lg">Notification Date</th>
                            </tr>
                        </thead>

                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Mid Term Exam Reminder</td>
                                <td className="px-2 py-4">Mid Term</td>
                                <td className="px-2 py-4">Mathematics</td>
                                <td className="px-2 py-4">10-09-2025</td>
                                <td className="px-2 py-4">09:00 AM</td>
                                <td className="px-2 py-4">Room 101</td>
                                <td className="px-2 py-4">Please arrive 15 minutes before exam time.</td>
                                <td className='px-2 py-4 rounded-e-lg'>08-09-2025</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
