        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Event Notifications List</h2>
                </div>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Annual Day Celebration</td>
                                <td className="px-2 py-4">Cultural</td>
                                <td className="px-2 py-4">20-12-2025</td>
                                <td className="px-2 py-4">School Auditorium</td>
                                <td className="px-2 py-4">Mrs. Priya</td>
                                <td className="px-2 py-4 rounded-e-lg">Students should report by 04:00 PM in costume.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
