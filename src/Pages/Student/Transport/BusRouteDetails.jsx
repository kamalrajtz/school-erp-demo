        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Bus Route Details</h2>
                </div>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">VH-001</td>
                                <td className="px-2 py-4">TN55 AB 1234</td>
                                <td className="px-2 py-4">Suresh Kumar</td>
                                <td className="px-2 py-4">+91 9876543210</td>
                                <td className="px-2 py-4">Anna Nagar Stop</td>
                                <td className="px-2 py-4">07:30 AM</td>
                                <td className="px-2 py-4">Anna Nagar Stop</td>
                                <td className="px-2 py-4">04:45 PM</td>
                                <td className="px-2 py-4 rounded-e-lg">Main Road, Market Area, Anna Nagar</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
