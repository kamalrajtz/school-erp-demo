...
const FeesPayemnt = () => {
    ...
    const bagdeColor = {
        ...
        "Partially Paid": "bg-[#FF980033] text-[#FF9800]",
        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Fees Payment List</h2>
                </div>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Fee Type</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Total Amount</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Paid Amount</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Due Amount</th>
