        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Study Material List</h2>
                </div>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">Algebra Basics</td>
                                <td className="px-2 py-4">
                                    <span className='flex items-center gap-x-2'>
                                        <img src={pdf_icon} alt="pdf-icon" className='w-6 h-6' />
                                        <span className='text-sm font-normal text-[#515DEF]'>Algebra_Notes.pdf</span>
                                    </span>
                                </td>
                                <td className="px-2 py-4">Mr. Ravi</td>
                                <td className="px-2 py-4">05-08-2025</td>
                                <td className="px-2 py-4">Introduction to algebra concepts and basic equations</td>
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">
                                    <span className='flex items-center gap-x-2'>
                                        <img src={mp4_icon} alt="mp4-icon" className='w-6 h-6' />
                                        <span className='text-sm font-normal text-[#515DEF]'>Electricity_Notes.mp4</span>
                                    </span>
                                </td>
                                <td className="px-2 py-4">Mrs. Divya</td>
                                <td className="px-2 py-4">04-08-2025</td>
                                <td className="px-2 py-4">Explanation of electric current, circuits, and examples</td>
                                <td className="px-2 py-4 rounded-e-lg">
                                    <Dropdown
                                        buttonContent={<EllipsisIcon size={16} className='text-black' />}
                                    >
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">Grammar Rules</td>
                                <td className="px-2 py-4">
                                    <span className='flex items-center gap-x-2'>
                                        <img src={pdf_icon} alt="pdf-icon" className='w-6 h-6' />
                                        <span className='text-sm font-normal text-[#515DEF]'>Grammar_Handbook.pdf</span>
                                    </span>
                                </td>
                                <td className="px-2 py-4">Mr. Paul</td>
                                <td className="px-2 py-4">03-08-2025</td>
                                <td className="px-2 py-4">Basic grammar rules with examples and exercises</td>
                                <td className="px-2 py-4 rounded-e-lg">
                                    <Dropdown
                                        buttonContent={<EllipsisIcon size={16} className='text-black' />}
                                    >
