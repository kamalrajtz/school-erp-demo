                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Subject</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Mathematics</td>
                                <td className="px-2 py-4">Mid Term Exam</td>
                                <td className="px-2 py-4">
                                    <span className='flex items-center gap-x-2'>
                                        <img src={pdf_icon} alt="pdf-icon" className='w-6 h-6' />
                                        <span className='text-sm font-normal text-[#515DEF]'>Maths_UnitTest_Paper_2025.pdf</span>
                                    </span>
                                </td>
                                <td className="px-2 py-4">Mr. Ravi</td>
                                <td className="px-2 py-4">05-08-2025</td>
                                <td className="px-2 py-4">Practice questions on algebra and geometry</td>
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Science</td>
                                <td className="px-2 py-4">Unit Test</td>
                                <td className="px-2 py-4">
                                    <span className='flex items-center gap-x-2'>
                                        <img src={pdf_icon} alt="pdf-icon" className='w-6 h-6' />
                                        <span className='text-sm font-normal text-[#515DEF]'>Science_Model_Paper_2025.mp4</span>
                                    </span>
                                </td>
                                <td className="px-2 py-4">Mrs. Divya</td>
                                <td className="px-2 py-4">04-08-2025</td>
                                <td className="px-2 py-4">Model paper covering physics and chemistry topics</td>
                                <td className="px-2 py-4 rounded-e-lg">
                                    <Dropdown
                                        buttonContent={<EllipsisIcon size={16} className='text-black' />}
                                    >
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">English</td>
                                <td className="px-2 py-4">Annual Exam</td>
                                <td className="px-2 py-4">
                                    <span className='flex items-center gap-x-2'>
                                        <img src={pdf_icon} alt="pdf-icon" className='w-6 h-6' />
                                        <span className='text-sm font-normal text-[#515DEF]'>English_MidTerm_Paper_2025.pdf</span>
                                    </span>
                                </td>
                                <td className="px-2 py-4">Mr. Paul</td>
                                <td className="px-2 py-4">03-08-2025</td>
                                <td className="px-2 py-4">Includes grammar, comprehension, and writing sections</td>
                                <td className="px-2 py-4 rounded-e-lg">
                                    <Dropdown
                                        buttonContent={<EllipsisIcon size={16} className='text-black' />}
                                    >
...
export default SampleQuestionsList