                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">BR001</td>
                                <td className="px-2 py-4">Fundamentals of Mathematics</td>
                                <td className="px-2 py-4">R.S. Aggarwal</td>
                                <td className="px-2 py-4">01-08-2025</td>
                                <td className="px-2 py-4">15-08-2025</td>
                                <td className="px-2 py-4 rounded-e-lg">
                                    <span className={`text-xs font-medium px-2 py-1 rounded-md ${bagdeColor["Borrowed"]}`}>Borrowed</span>
                                </td>
                            </tr>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">BR002</td>
                                <td className="px-2 py-4">English Grammar Guide</td>
                                <td className="px-2 py-4">Wren & Martin</td>
                                <td className="px-2 py-4">20-07-2025</td>
                                <td className="px-2 py-4">03-08-2025</td>
                                <td className="px-2 py-4 rounded-e-lg">
                                    <span className={`text-xs font-medium px-2 py-1 rounded-md ${bagdeColor["Overdue"]}`}>Overdue</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
