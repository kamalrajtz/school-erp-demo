...
import SubmitAssignModal from './Components/SubmitAssignModal';
...
const AssignmentList = () => {
    ...
    const bagdeColor = {
        ...
        "Late Submission": "bg-[#FF000033] text-[#FF0000]",
    }
    ...
    return (
        <>
                        ...
                        <table className="w-full text-sm text-left rtl:text-right">
                            <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                                <tr className='rounded-lg'>
                                    <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Assignment Title</th>
                            ...
                            <tbody>
                                <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                    <td className="px-2 py-4 rounded-s-lg">Algebra Homework</td>
                                    ...
                                    <td className="px-2 py-4">Solve algebra equations from chapter 3</td>
                                    <td className="px-2 py-4">
                                        <span className='flex items-center gap-x-2'>
                                            <img src={pdf_icon} alt="pdf-icon" className='w-6 h-6' />
                                            <span className='text-sm font-normal text-[#515DEF]'>Maths_Questions.pdf</span>
                                        </span>
                                    </td>
                                    <td className="px-2 py-4">
                                        <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Submitted"]}`}>
                                            Submitted
                                        </span>
                                    </td>
                                    <td className='px-2 py-4 rounded-e-lg'>
                                        ...
                                        >
                                            ...
                                            <button onClick={() => setSubmitAssignModal(true)} className="w-full text-left p-2 hover:bg-[#515DEF] hover:text-white rounded cursor-pointer">
                                                Submit
                                            </button>
                                        </Dropdown>
                                    </td>
                                ...
                                <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                    ...
                                    <td className="px-2 py-4">
                                        <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Late Submission"]}`}>
                                            Late Submission
                                        </span>
                                    </td>
                                    <td className='px-2 py-4 rounded-e-lg'>
            ...
            <SubmitAssignModal submitAssignModal={submitAssignModal} setSubmitAssignModal={setSubmitAssignModal} />
        </>
    )
}
