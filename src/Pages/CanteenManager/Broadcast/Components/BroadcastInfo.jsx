            ...
            <div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                    <div className='lg:col-span-2 flex flex-col gap-y-2'>
                        ...
                        <input type="text" id="broadcast-title" placeholder="Enter broadcast title" className={inputClass} />
                    </div>
                    <div className='flex flex-col gap-y-2'>
                        <label htmlFor="broadcast-category" className='text-base font-medium text-[#1E1E1E]'>Category *</label>
                        <select id="broadcast-category" className={selectClass} defaultValue="">
                    ...
                    <div className='lg:col-span-3 flex flex-col gap-y-2'>
                        <label htmlFor="broadcast-message" className='text-base font-medium text-[#1E1E1E]'>Message *</label>
                        <textarea id="broadcast-message" rows={4} placeholder="Enter broadcast message" className={`${inputClass} resize-none`} />
                    </div>
                </div>
            </div>
