...
import { ANNOUNCEMENTS, priorityBadgeColor, statusBadgeColor } from './announcementData'
        ...
        <section>
            <div className='bg-white rounded-2xl shadow-md p-4'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:mt-8 mt-2'>
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <input type="text" placeholder="Announcement ID, title..." className='text-sm text-[#808080] border border-[#D9D9D9] rounded-md px-2 py-2 w-full' />
                    </div>
                    <div className='flex flex-col gap-y-2'>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Announcement</h2>
                ...
                <div className="relative overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody>
                            {BROADCASTS.map((announcement) => (
                                <tr key={announcement.broadcastId} className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7]">
                                    <td className="px-2 py-4 font-medium text-[#1E1E1E] rounded-s-lg">{announcement.announcementId}</td>
                                    <td className="px-2 py-4 max-w-[160px] truncate" title={announcement.title}>{announcement.title}</td>
                                    <td className="px-2 py-4">{announcement.audience}</td>
                                    <td className="px-2 py-4">{announcement.category}</td>
                                    <td className="px-2 py-4">
                                        <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${priorityBadgeColor[announcement.priority]}`}>
                                            {announcement.priority}
                                        </span>
                                    </td>
                                    <td className="px-2 py-4">{announcement.sentBy}</td>
                                    <td className="px-2 py-4 whitespace-nowrap">{announcement.publishDate}</td>
                                    <td className="px-2 py-4 whitespace-nowrap">{announcement.expiryDate}</td>
                                    <td className="px-2 py-4">
                                        <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${statusBadgeColor[announcement.status]}`}>
                                            {announcement.status}
                                        </span>
                                    </td>
                                    <td className="px-2 py-4 text-center rounded-e-lg">
                                        <Dropdown buttonContent={<EllipsisIcon size={16} className='text-black' />}>
                                            <NavLink to={`/canteen-manager/announcement/view-announcement/${announcement.announcementId}`} className="w-full text-left p-2 hover:bg-[#515DEF] hover:text-white rounded cursor-pointer block">View</NavLink>
