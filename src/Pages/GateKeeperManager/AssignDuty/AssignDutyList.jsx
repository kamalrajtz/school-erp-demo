...
import { Calendar, ChevronLeft, ChevronRight, Download, Plus, EllipsisIcon } from "lucide-react";
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    ...
                    <div className='flex gap-x-2'>
                        <NavLink to="/gatekeeper-manager/assign-duty" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Assign Duty
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Duty ID</th>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Gate Location</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">DUT001</td>
                                <td className="px-2 py-4">Suresh Kumar</td>
                                <td className="px-2 py-4">GK001</td>
                                <td className="px-2 py-4">Main Gate</td>
                                <td className="px-2 py-4">Morning Shift</td>
                                <td className="px-2 py-4">05-08-2025</td>
                                <td className="px-2 py-4">07:00 AM</td>
                                <td className="px-2 py-4">01:00 PM</td>
                                <td className="px-2 py-4">Gate Manager</td>
