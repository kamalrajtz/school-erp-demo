        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Incidents Management List</h2>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase text-center rounded-s-lg">Incident ID</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Incident Type</th>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Incident Date</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Incident Time</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Description</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-e-lg">Priority</th>
                            </tr>
                        </thead>
