        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Leave Approval List</h2>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase text-center rounded-s-lg">Leave Request ID</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">LR001</td>
                                <td className="px-2 py-4">GK001</td>
                                <td className="px-2 py-4">Suresh Kumar</td>
                                <td className="px-2 py-4">Sick Leave</td>
                                <td className="px-2 py-4">15-08-2025</td>
                                <td className="px-2 py-4">16-08-2025</td>
                                <td className="px-2 py-4">2</td>
                                <td className="px-2 py-4">Fever and doctor consultation.</td>
                                <td className="px-2 py-4">13-08-2025</td>
