...
import { calculateTotalDays, createMyLeaveRequest, HIGHER_HIERARCHY, LEAVE_TYPES } from './leaveRequestData'
...
const AddLeaveRequest = () => {
    ...
    const handleSubmit = () => {
        ...
        const created = createMyLeaveRequest({
            leaveType,
            fromDate,
            toDate,
            totalDays,
        ...
        navigate(`/gatekeeper-manager/leave-request/my-requests/view/${created.id}`)
    }
    ...
    return (
        <section>
            ...
            <div className='flex sm:justify-end justify-center gap-x-4 mt-6'>
                <button type='button' onClick={() => navigate('/gatekeeper-manager/leave-request/my-requests')} className='bg-white text-[#515DEF] text-sm px-12 py-2 rounded-md border border-[#515DEF] hover:bg-[#515DEF] hover:text-white transition-all duration-200 cursor-pointer md:w-auto w-full'>Discard Changes</button>
