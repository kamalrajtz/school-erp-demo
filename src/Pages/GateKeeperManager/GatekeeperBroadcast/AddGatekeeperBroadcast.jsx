    ...
    return (
        <section>
            <div className='bg-white rounded-2xl shadow-md p-4'>
                <h2 className='text-xl font-semibold text-black'>Add Gatekeeper Broadcast Information</h2>
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 lg:mt-8 mt-2'>
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <input type="text" id="broadcast-id" placeholder="GKB001" className={inputClass} />
                    </div>
                    <div className='flex flex-col gap-y-2'>
                        <label htmlFor="broadcast-title" className='text-base font-medium text-[#1E1E1E]'>Broadcast Title:</label>
                        <input type="text" id="broadcast-title" placeholder="Main Gate Closure Notice" className={inputClass} />
                    </div>
                    <div className='flex flex-col gap-y-2'>
                    ...
                    <div className='flex flex-col gap-y-2 lg:col-span-3'>
                        ...
                        <input type="text" id="broadcast-message" placeholder="Main gate will be closed from 2 PM to 4 PM for maintenance." className={inputClass} />
                    </div>
                    <div className='flex flex-col gap-y-2'>
                    ...
                    <div className='col-span-3 flex flex-col gap-y-2'>
                        <label htmlFor="broadcast-attachment" className='text-base font-medium text-[#1E1E1E]'>Upload Attachment:</label>
                        <ProofUpload />
                    </div>
                </div>
...
export default AddGatekeeperBroadcast