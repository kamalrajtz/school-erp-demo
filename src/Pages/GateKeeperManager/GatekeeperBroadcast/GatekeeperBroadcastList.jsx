        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Gatekeeper Broadcast List</h2>
                    <div className='flex gap-x-2'>
                        <NavLink to="/gatekeeper-manager/add-gatekeeper-broadcast" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Add Gatekeeper Broadcast
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Broadcast Title</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Attachment</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Broadcast Category</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Broadcast Message</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Sent By</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Broadcast Date</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Visible To</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">GKB001</td>
                                <td className="px-2 py-4">Main Gate Closure Notice</td>
                                <td className="px-2 py-4">
                                    <span className='flex items-center gap-x-2'>
                                        <img src={pdf_icon} alt="pdf-icon" className='w-6 h-6' />
                                        Main-Gate-Closure-Notice.pdf
                                    </span>
                                </td>
                                <td className="px-2 py-4">Security Alert</td>
                                <td className="px-2 py-4">Main gate will be closed from 2 PM to 4 PM for maintenance.</td>
                                <td className="px-2 py-4">Gatekeeper Manager</td>
                                <td className="px-2 py-4">10-08-2025</td>
                                <td className="px-2 py-4">All Gate Keepers</td>
...
export default GatekeeperBroadcastList