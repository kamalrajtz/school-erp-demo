...
const ViewAtr = () => {
    ...
    if (!record) {
        return (
            <section className='space-y-6'>
                <button
                    type='button'
                    onClick={() => navigate('/process-auditor/corrective-actions/action-taken-reports')}
    ...
    return (
        <section className='space-y-6'>
            ...
            <AuditReviewPanel recordId={record.id} kind="ATR" stream="PROCESS" originalSummary={record.actionTaken?.description || record.observationTitle} />
        </section>
    )
}
