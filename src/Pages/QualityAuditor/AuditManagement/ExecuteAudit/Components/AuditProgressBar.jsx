        ...
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3'>
            ...
            <div className='flex gap-4 text-center'>
                <div>
                    ...
                    <p className='text-2xl font-bold text-[#515DEF] transition-all duration-500'>{scores.overallQualityScore}%</p>
                </div>
                <div>
                    <p className='text-[10px] text-[#808080] uppercase'>Avg Rating</p>
                    <p className='text-lg font-bold text-[#515DEF]'>
                        {scores.averageRating ? `${scores.averageRating} / 5` : '— / 5'}
                    </p>
                </div>
                <div>
                    <p className='text-[10px] text-[#808080] uppercase'>Excellent</p>
                    <p className='text-lg font-bold text-[#4CAF50]'>{scores.excellent}</p>
                </div>
                <div>
                    <p className='text-[10px] text-[#808080] uppercase'>Critical</p>
                    <p className='text-lg font-bold text-[#FF0000]'>{scores.critical}</p>
                </div>
            </div>
        </div>
