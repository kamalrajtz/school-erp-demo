        ...
        <div className='flex flex-col xl:flex-row xl:items-center xl:justify-between gap-3'>
            <div className='flex flex-wrap items-center gap-x-5 gap-y-2'>
                <div>
                    ...
                    <p className='text-xl font-bold text-[#515DEF] transition-all duration-300'>{scores.overallQualityScore}%</p>
                </div>
                <div className='h-8 w-px bg-[#E0E0E0] hidden sm:block' />
                <div>
                    <p className='text-[10px] text-[#808080] uppercase'>Avg Rating</p>
                    <p className='text-base font-bold text-[#515DEF]'>
                        {scores.averageRating ? `${scores.averageRating} / 5` : '— / 5'}
                    </p>
                </div>
                <div>
                    <p className='text-[10px] text-[#808080] uppercase'>Excellent</p>
                    <p className='text-base font-bold text-[#4CAF50]'>{scores.excellent}</p>
                </div>
                <div>
                    <p className='text-[10px] text-[#808080] uppercase'>Critical</p>
                    <p className='text-base font-bold text-[#FF0000]'>{scores.critical}</p>
                </div>
