...
import { DAYS, SUBJECTS, createTimelineRow } from '../examinationTimetableData'
...
const ExamTimelineEditor = ({ timelines, onChange, readOnly = false }) => {
    ...
    return (
        <div>
            <div className='flex justify-between items-center mb-4'>
                <h3 className='text-lg font-semibold text-black'>Exam Timelines</h3>
                {!readOnly && (
                    <button
                        type='button'
                        onClick={addRow}
            ...
            <div className='overflow-x-auto'>
                <table className='w-full text-sm text-left'>
                    <thead className='text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg'>
                        <tr>
                            <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg'>Day</th>
...
export default ExamTimelineEditor
