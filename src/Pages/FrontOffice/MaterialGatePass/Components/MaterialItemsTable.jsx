...
import { createEmptyMaterialRow } from '../materialGatePassData'

const inputClass =
    'text-sm font-normal text-[#1E1E1E] border border-[#D9D9D9] rounded-md px-2 py-2 w-full min-w-0'

const MaterialItemsTable = ({ materials, onChange, errors = {} }) => {
    ...
    const addRow = () => onChange([...materials, createEmptyMaterialRow()])
    ...
    return (
        <div className='space-y-3'>
            <div className='flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between'>
                <h3 className='text-base font-semibold text-[#0C1E5B]'>Material Details</h3>
                <button
                    type='button'
                    onClick={addRow}
                ...
                <table className='w-full min-w-[760px] text-sm'>
                    <thead className='bg-[#EDEEF5] text-xs uppercase text-[#0C1E5B]'>
                        <tr>
                            ...
                            <th className='px-3 py-3 text-left font-medium'>Details of the Destination</th>
