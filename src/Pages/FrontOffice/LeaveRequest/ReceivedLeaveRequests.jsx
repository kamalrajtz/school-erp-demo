...
import { LEAVE_STATUSES, RECEIVED_FROM_ROLE, RECEIVED_LEAVE_REQUESTS, statusBadgeColor } from './leaveRequestData'
            ...
            <div className='bg-white rounded-2xl shadow-md p-4'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <select className='text-sm text-[#808080] border border-[#D9D9D9] rounded-md px-2 py-2 w-full' defaultValue={RECEIVED_FROM_ROLE}>
                            <option value=''>All</option>
                            <option value={RECEIVED_FROM_ROLE}>{RECEIVED_FROM_ROLE}</option>
                        </select>
                    </div>
                    <div className='flex flex-col gap-y-2'>
                                ...
                                <tr key={request.id} className='border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7]'>
                                    ...
                                    <td className='px-2 py-4 text-center rounded-e-lg'>
                                        <Dropdown buttonContent={<EllipsisIcon size={16} className='text-black' />}>
                                            <NavLink to={`/front-office/leave-request/received/view/${request.id}`} className='block w-full text-left p-2 hover:bg-[#515DEF] hover:text-white rounded cursor-pointer'>View</NavLink>
