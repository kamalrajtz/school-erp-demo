 ...
 * - schedule: Record<string, Record<string, { subject: string; date: string }>>
 *     Keys are time slot labels → day names → exam details
 *     e.g. { "10:30 AM - 12:30 PM": { Monday: { subject: "Tamil", date: "02/05/2026" }, ... } }
