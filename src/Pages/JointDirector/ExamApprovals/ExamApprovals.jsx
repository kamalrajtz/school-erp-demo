        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Examination List</h2>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">EXM001</td>
                                <td className="px-2 py-4">Mid Term Examination</td>
                                    ...
                                    >
                                        {approvalStatusOptions.map((option) => (
                                            <option
                                                key={option.value}
                                                value={option.value}
                                                className={approvalStatusColor[option.value]}
                                            >
                                                {option.label}
                                            </option>
                                        ))}
                                ...
                                <td className='px-2 py-4 rounded-e-lg'>
                                    <button onClick={() => setTimeTableModal(true)} className='bg-[#515DEF] text-white text-sm px-2 py-1.5 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                                        <Eye size={16} />
                                        View Timetable
                                    </button>
                                </td>
