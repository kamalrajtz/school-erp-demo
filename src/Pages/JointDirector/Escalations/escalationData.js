...
export const ESCALATIONS = [
    ...
    {
        id: 'ESC-2026-013',
        escalatedBy: 'Meera Sharma',
        escalatedByRole: 'JD Assistant',
        escalatedById: 'JDA-1001',
        description: 'Cross-department vendor payment dispute — canteen & transport.',
        escalationDate: '05-06-2026',
        escalatedDepartment: 'Joint Director Office',
        sourceType: 'jd-assistant',
        status: 'Escalated to Admin',
        priority: 'High',
        fullDescription:
            'Shared vendor (FreshServe Logistics) invoiced canteen and transport departments for overlapping delivery charges totalling ₹24,500. Both managers dispute duplicate billing. Requires Admin finance team intervention for vendor account reconciliation.',
        remarks: 'JD Assistant consolidated dispute documents and escalated to Admin on 06-06-2026.',
        escalatedToAdmin: true,
        adminEscalationDate: '06-06-2026',
        adminEscalationNote: 'Forwarded to Admin finance for vendor payment dispute resolution.',
    },
    {
        id: 'ESC-2026-012',
        escalatedBy: 'Karthik Rajan',
...
export const sourceTypeLabel = {
    ...
    'jd-assistant': 'From JD Assistant',
}
