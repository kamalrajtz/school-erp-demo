        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>My Documents List</h2>
                    <div className='flex gap-x-2'>
                        <NavLink to="/joint-director/documents/add-documents" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Add Documents
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Document Name</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Document Format</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Document Category</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Document Description</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">DOC001</td>
                                <td className="px-2 py-4">Government Education Circular</td>
                                <td className="px-2 py-4">
                                    <span className='flex items-center gap-x-2'>
                                        <img src={pdf_icon} alt="pdf-icon" className='w-6 h-6' />
                                        Education-Circle-Circular.pdf
                                    </span>
                                </td>
                                <td className="px-2 py-4">Government Orders</td>
                                <td className="px-2 py-4">Latest government guidelines for school administration.</td>
                                <td className="px-2 py-4">Joint Director</td>
