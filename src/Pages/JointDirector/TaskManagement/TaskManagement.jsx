            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    ...
                    <div className='flex gap-x-2'>
                        <NavLink to="/joint-director/task-management/add-task" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Add Task
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">TASK001</td>
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">TASK002</td>
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">TASK003</td>
                                <td className="px-2 py-4">Update the School Website</td>
                                <td className="px-2 py-4">Update the school website with the latest information and news.</td>
                                <td className="px-2 py-4">Mr. Shah</td>
                                <td className="px-2 py-4">IT Department</td>
                                <td className="px-2 py-4">High</td>
                                <td className="px-2 py-4">01-08-2025</td>
                                <td className="px-2 py-4">05-08-2025</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["In Complete"]}`}>
                                        In Complete
                                    </span>
                                </td>
                                <td className="px-2 py-4 text-center rounded-e-lg">
