...
const IssuedBooks = () => {
    ...
    const bagdeColor = {
        ...
        "Issued": "bg-[#FF980033] text-[#FF9800]",
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    ...
                    <div className='flex gap-x-2'>
                        <NavLink to="/librarian/issued-books/add-issued-book" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Add New Issue Book
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Book Name</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Issued To</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Name</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Issued Date</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Return Date</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Late Fees</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Return Comment</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">STU1909</td>
                                <td className="px-2 py-4">Mathematics</td>
                                <td className="px-2 py-4">Student</td>
                                <td className="px-2 py-4">Sandy</td>
                                <td className="px-2 py-4">20-05-2026</td>
                                <td className="px-2 py-4">25-05-2026</td>
                                <td className="px-2 py-4">₹ 50</td>
                                <td className="px-2 py-4">No Issues</td>
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">No Issues</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Issued"]}`}>
                                        Issued
                                    </span>
                                </td>
                                <td className="px-2 py-4 text-center rounded-e-lg">
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">No Issues</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Overdue"]}`}>
                                        Overdue
                                    </span>
                                </td>
                                <td className="px-2 py-4 text-center rounded-e-lg">
