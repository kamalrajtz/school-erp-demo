...
const ViewAnnouncement = () => {
    ...
    return (
        <section className='space-y-6'>
            <button type='button' onClick={() => navigate('/librarian/announcement')} className='inline-flex items-center gap-2 text-sm text-[#515DEF] border border-[#515DEF] rounded-md px-4 py-2 hover:bg-[#515DEF] hover:text-white transition-colors cursor-pointer'>
                <ArrowLeft size={18} />
                Back to list
            </button>
