...
import { getStudyMaterialById } from './studyMaterialsData'
                ...
                <>
                    <div className='bg-white rounded-2xl shadow-md p-4'>
                        ...
                        <p className='text-sm text-[#667085] mt-2'>
                            <span className='font-medium text-[#1E1E1E]'>{record.materialTitle}</span>
                            {' · '}
                    ...
                    <Section title='Study Materials Information'>
                        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                            ...
                            <Field label='Material Title' value={record.materialTitle} />
