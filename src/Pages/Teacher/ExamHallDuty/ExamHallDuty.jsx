...
import { EXAM_HALL_DUTY_LIST, SUBJECTS } from './examHallDutyData'
        ...
        <section>
            <div className='bg-white rounded-2xl shadow-md p-4'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:mt-8 mt-2'>
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <input type='text' id='search' placeholder='Duty ID, exam name, hall...' className='text-sm font-normal text-[#808080] border border-[#D9D9D9] rounded-md px-2 py-2 w-full' />
                    </div>
                    <div className='flex flex-col gap-y-2'>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Exam Hall Duty List</h2>
                    <button
                        type='button'
                    ...
                    <table className='w-full text-sm text-left rtl:text-right'>
                        <thead className='text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg'>
                            <tr className='rounded-lg'>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg'>Duty ID</th>
                                ...
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Exam Date</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Hall Number</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Building Name</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Floor Number</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Reporting Time</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Exam Start Time</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Exam End Time</th>
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-e-lg'>Assigned By</th>
                            </tr>
                        </thead>
                        <tbody>
                            {EXAM_HALL_DUTY_LIST.map((record) => (
                                <tr key={record.id} className='border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg'>
                                    <td className='px-2 py-4 font-medium text-[#1E1E1E] rounded-s-lg'>{record.dutyId}</td>
                                    <td className='px-2 py-4 font-medium text-[#1E1E1E]'>{record.teacherName}</td>
                                    <td className='px-2 py-4'>{record.employeeId}</td>
                                    <td className='px-2 py-4'>{record.examName}</td>
                                    <td className='px-2 py-4'>{record.subject}</td>
                                    <td className='px-2 py-4'>{record.examDate}</td>
                                    <td className='px-2 py-4'>{record.hallNumber}</td>
                                    <td className='px-2 py-4'>{record.buildingName}</td>
                                    <td className='px-2 py-4'>{record.floorNumber}</td>
                                    <td className='px-2 py-4'>{record.reportingTime}</td>
                                    <td className='px-2 py-4'>{record.examStartTime}</td>
                                    <td className='px-2 py-4'>{record.examEndTime}</td>
                                    <td className='px-2 py-4 rounded-e-lg'>{record.assignedBy}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
            ...
            <div className='flex justify-between items-center px-4 mt-4'>
                <p className='text-sm font-medium text-[#515DEF]'>
                    Showing 1 to {EXAM_HALL_DUTY_LIST.length} of {EXAM_HALL_DUTY_LIST.length} entries
                </p>
