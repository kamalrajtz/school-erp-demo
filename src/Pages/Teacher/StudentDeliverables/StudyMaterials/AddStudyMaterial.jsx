...
import { addStudyMaterial, DEFAULT_ROUTE_BASE } from './studyMaterialsData'

const AddStudyMaterial = ({ routeBase = DEFAULT_ROUTE_BASE }) => {
    const navigate = useNavigate()

    const handleSave = (values) => {
        addStudyMaterial(values)
        navigate(routeBase)
    }
    ...
    return (
        <section>
            <div className='bg-white rounded-2xl shadow-md p-4'>
                <h2 className='text-xl font-semibold text-black'>Study Material Information</h2>
                <StudyMaterialForm formId='study-material-form' onSubmit={handleSave} />
            </div>
