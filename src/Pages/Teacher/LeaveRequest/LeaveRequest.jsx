        ...
        <section>
            <div className='bg-white rounded-2xl shadow-md p-4'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:mt-8 mt-2'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        <label htmlFor='leave-type-filter' className='text-base font-medium text-[#808080]'>Leave Type</label>
                        <select id='leave-type-filter' className='text-sm font-normal text-[#808080] border border-[#D9D9D9] rounded-md px-2 py-2 w-full'>
                    ...
                    <table className='w-full text-sm text-left rtl:text-right'>
                        <thead className='text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg'>
                            <tr className='rounded-lg'>
                                ...
                                <th className='px-2 py-3.5 text-[#0C1E5B] font-medium uppercase'>Parent Contact</th>
                        ...
                        <tbody>
                            {LEAVE_REQUESTS.map((request) => (
                                <tr key={request.id} className='border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg'>
                                    ...
                                    <td className='px-2 py-4 font-medium text-[#1E1E1E]'>{request.studentName}</td>
                                    <td className='px-2 py-4'>{request.admissionNumber}</td>
                                    ...
                                    <td className='px-2 py-4 max-w-xs'>{request.reason}</td>
                                    <td className='px-2 py-4'>{request.parentName}</td>
                                    <td className='px-2 py-4 whitespace-nowrap'>{request.parentContact}</td>
            ...
            <div className='flex justify-between items-center px-4 mt-4'>
                <p className='text-sm font-medium text-[#515DEF]'>
                    Showing 1 to {LEAVE_REQUESTS.length} of {LEAVE_REQUESTS.length} entries
                </p>
