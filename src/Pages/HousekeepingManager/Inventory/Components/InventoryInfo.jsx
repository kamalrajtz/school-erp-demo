...
const InventoryInfo = () => {
    ...
    return (
        <div className='space-y-8 lg:mt-8 mt-2'>
            <div>
                <h3 className='text-base font-semibold text-[#1E1E1E] mb-4'>Product Information</h3>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                    <div className='lg:col-span-2 flex flex-col gap-y-2'>
                        <label htmlFor="product-name" className='text-base font-medium text-[#1E1E1E]'>Product Name</label>
                        <input type="text" id="product-name" placeholder="Enter product name" className={inputClass} />
                    </div>
                    ...
                    <div className='lg:col-span-3 flex flex-col gap-y-2'>
                        ...
                        <textarea id="description" rows={3} placeholder="Brief description of the product" className={`${inputClass} resize-none`} />
                    </div>
                </div>
            </div>
