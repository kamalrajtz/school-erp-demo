            ...
            <div className='bg-white rounded-2xl shadow-md p-4'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:mt-8 mt-2'>
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <input type="text" placeholder="Product ID, name..." className='text-sm text-[#808080] border border-[#D9D9D9] rounded-md px-2 py-2 w-full' />
                    </div>
                    <div className='flex flex-col gap-y-2'>
                ...
                <div className="relative overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Product ID</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Product Name</th>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Available Quantity</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Reorder Level</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Last Purchase Date</th>
                        ...
                        <tbody>
                            {INVENTORY_ITEMS.map((item) => (
                                <tr key={item.productId} className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7]">
                                    <td className="px-2 py-4 font-medium text-[#1E1E1E] rounded-s-lg">{item.productId}</td>
                                    <td className="px-2 py-4 max-w-[140px] truncate" title={item.productName}>{item.productName}</td>
                                    ...
                                    <td className="px-2 py-4 whitespace-nowrap">{item.lastPurchaseDate}</td>
                                    ...
                                    <td className="px-2 py-4 text-center rounded-e-lg">
                                        <Dropdown buttonContent={<EllipsisIcon size={16} className='text-black' />}>
                                            <NavLink to={`/housekeeping-manager/inventory/view-item/${item.productId}`} className="w-full text-left p-2 hover:bg-[#515DEF] hover:text-white rounded cursor-pointer block">View</NavLink>
