...
const StudentWise = () => {
    ...
    return (
        <div>
            <h2 className='text-xl font-medium text-black mb-4'>Student Wise Attendance</h2>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-e-lg">Section</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            {Array.from({ length: 8 }).map((_, index) => (
                                <tr key={index} className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                    ...
                                    <td className="px-2 py-4">10th</td>
