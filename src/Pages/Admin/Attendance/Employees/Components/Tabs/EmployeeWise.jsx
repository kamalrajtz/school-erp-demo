...
const EmployeeWise = () => {
    ...
    return (
        <div>
            <h2 className='text-xl font-medium text-black mb-4'>Employee Wise Attendance</h2>
                ...
                <table className="w-full text-sm text-left rtl:text-right">
                    <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                        <tr className='rounded-lg'>
                            ...
                            <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-e-lg">Employee Role</th>
                        </tr>
                    </thead>
                    <tbody>
