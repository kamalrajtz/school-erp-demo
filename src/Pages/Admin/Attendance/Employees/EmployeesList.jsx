...
import EmployeeWise from './Components/Tabs/EmployeeWise'
import RoleWise from './Components/Tabs/RoleWise'
import DateWise from './Components/Tabs/DateWise'
...
const EmployeesList = () => {
    ...
    return (
        <section>
            <div className='bg-white rounded-2xl shadow-md p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 items-end gap-4'>
                <button className='bg-[#515DEF] text-white uppercase text-sm px-6 py-2 border border-[#515DEF] rounded-lg hover:opacity-90 w-full transition-all duration-200 cursor-pointer'>Clear Filters</button>
                ...
                <div className='flex flex-col gap-y-2'>
                    <label htmlFor="search" className='text-base font-medium text-[#808080]'>Role</label>
                ...
                {activeTab == 3 && (
                    <>
                        <div className='flex flex-col gap-y-2'>
                            <label htmlFor="" className='text-base font-medium text-[#808080]'>From Date:</label>
                        ...
                        <div className='flex flex-col gap-y-2'>
                            <label htmlFor="" className='text-base font-medium text-[#808080]'>To Date:</label>
                            <div className='relative'>
                                <DatePicker
                                    selected={toDate}
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-6'>
                <div className="flex gap-4 overflow-x-auto no-scrollbar">
                    {[
                        { id: 1, label: "Employee Wise" },
                        { id: 2, label: "Role Wise" },
                ...
                <>
                    <div className='mt-6'>
                        {activeTab === 1 && <EmployeeWise />}
                        {activeTab === 2 && <RoleWise />}
