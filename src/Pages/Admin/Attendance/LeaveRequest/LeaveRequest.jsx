...
const LeaveRequest = () => {
    ...
    const bagdeColor = {
        ...
        "Requested": "bg-[#FF980033] text-[#FF9800]",
        "Denied": "bg-[#FF000033] text-[#FF0000]",
    }
        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Leave Request List</h2>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-center text-[#0C1E5B] font-medium uppercase rounded-s-lg">Profile</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Employee Name</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Leave Description</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">Fever for 2 Days</td>
                                <td className="px-2 py-4">24/02/2026</td>
                                <td className="px-2 py-4">09/03/2026</td>
                                <td className="px-2 py-4">12/03/2026</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Approved"]}`}>
                                        Approved
                                    </span>
                                </td>
                                <td className="px-2 py-4 text-center rounded-e-lg">
                                    ...
                                    >
                                        <NavLink to="/admin/attendance/leave-request" className="w-full text-left p-2 hover:bg-[#515DEF] hover:text-white rounded cursor-pointer">
                                            View
                                        </NavLink>
                                        <NavLink to="/admin/attendance/leave-request" className="w-full text-left p-2 hover:bg-[#515DEF] hover:text-white rounded cursor-pointer">
                                            Edit
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">12/03/2026</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Requested"]}`}>
                                        Requested
                                    </span>
                                </td>
                                <td className="px-2 py-4 text-center rounded-e-lg">
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">12/03/2026</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Denied"]}`}>
                                        Denied
                                    </span>
                                </td>
                                <td className="px-2 py-4 text-center rounded-e-lg">
