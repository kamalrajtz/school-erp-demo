            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    ...
                    <div className='flex gap-x-2'>
                        <NavLink to="/admin/class/add-extended-class" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Add New Extended Class
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Class 12</td>
                                <td className="px-2 py-4">A</td>
                                <td className="px-2 py-4">Sandy Selva</td>
                                <td className="px-2 py-4">English</td>
                                <td className="px-2 py-4">Admin User</td>
                                <td className="px-2 py-4">02/04/2026</td>
                                <td className="px-2 py-4">10/04/2026</td>
                                <td className="px-2 py-4">6:30</td>
                                <td className="px-2 py-4">7:30</td>
                                <td className="px-2 py-4">Seminar Hall Room 1</td>
