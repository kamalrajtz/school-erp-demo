            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    ...
                    <div className='flex gap-x-2'>
                        <NavLink to="/admin/front-office/add-admission-enquiry" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">Advertisement</td>
                                <td className="px-2 py-4">24-05-2026</td>
                                <td className="px-2 py-4">Male</td>
                                <td className="px-2 py-4">12-16-2026</td>
                                <td className="px-2 py-4">Kamal</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Success"]}`}>
                                        Success
                                    </span>
                                </td>
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">Kamal</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Active"]}`}>
                                        Active
                                    </span>
                                </td>
                                <td className="px-2 py-4">Trichy</td>
                            ...
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                ...
                                <td className="px-2 py-4">Kamal</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["In Active"]}`}>
                                        In Active
                                    </span>
                                </td>
                                <td className="px-2 py-4">Trichy</td>
