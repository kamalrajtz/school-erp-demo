...
import { RECEIVED_TASKS, statusBadgeColor } from './taskData'
        ...
        <section>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <select className='text-sm text-[#808080] border border-[#D9D9D9] rounded-md px-2 py-2 w-full'>
                            ...
                            <option value='Director of Academics'>Director of Academics</option>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center mb-4'>
                    <h2 className='text-xl font-medium text-black'>Assigned Tasks List</h2>
            ...
            <div className='flex justify-between items-center px-4 mt-4'>
                <p className='text-sm font-medium text-[#515DEF]'>Showing 1 to {RECEIVED_TASKS.length} of {RECEIVED_TASKS.length} entries</p>
