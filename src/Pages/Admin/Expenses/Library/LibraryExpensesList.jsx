...
const LibraryExpensesList = () => {
    ...
    const bagdeColor = {
        ...
        "Not Paid": "bg-[#FF000033] text-[#FF0000]",
    }
        ...
        <section>
            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    <h2 className='text-xl font-medium text-black'>Library Expenses List</h2>
                    <div className='flex gap-x-2 items-center'>
                        <NavLink to="/admin/expenses/add-library-exp" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Add New Library Expense
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Book Name</th>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Vendors</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">Science Textbook Set</td>
                                <td className="px-2 py-4">Purchase</td>
                                <td className="px-2 py-4">₹12,000</td>
                                <td className="px-2 py-4">15-03-2026</td>
                                <td className="px-2 py-4">Purchase of science books for class 8</td>
                                <td className="px-2 py-4">ABC Book Suppliers</td>
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["Paid"]}`}>
                                        Paid
                                    </span>
                                </td>
...
export default LibraryExpensesList