...
import { calculateTotalDays, createAdminLeaveRequest, LEAVE_TYPES } from './leaveRequestData'
...
const AddLeaveRequest = () => {
    ...
    const handleSubmit = () => {
        if (!leaveType || !reason.trim()) {
            alert('Please select leave type and provide a reason.')
            return
        }
        ...
        navigate('/admin/leave-request/my-requests')
    }
