            ...
            <div className='bg-white rounded-2xl shadow-md p-4 mt-8'>
                <div className='flex justify-between items-center sm:flex-row flex-col gap-y-2 mb-4'>
                    ...
                    <div className='flex gap-x-2'>
                        <NavLink to="/admin/documents/add-student-documents" className='bg-[#515DEF] text-white text-sm px-4 py-2 rounded-md hover:opacity-90 transition-all duration-200 cursor-pointer flex items-center gap-x-2'>
                            <Plus size={16} />
                            Add New Documents
                        </NavLink>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right">
                        <thead className="text-xs bg-[#EDEEF5] whitespace-nowrap rounded-lg">
                            <tr className='rounded-lg'>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase rounded-s-lg">Admission Number</th>
                                ...
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Aadhaar</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Birth Certificate</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">TC</th>
                                <th className="px-2 py-3.5 text-[#0C1E5B] font-medium uppercase">Marksheet</th>
                        ...
                        <tbody>
                            <tr className="border-b text-[#667085] border-[#f2f4f7] hover:bg-[#f2f4f7] rounded-lg">
                                <td className="px-2 py-4 rounded-s-lg">ADM-NO1845</td>
                                <td className="px-2 py-4">Sandy Selva</td>
                                <td className="px-2 py-4">Class-12</td>
                                <td className="px-2 py-4">
                                    <span className={` ${statusColor["Approved"]}`}>
                                        Approved
                                    </span>
                                </td>
                                <td className="px-2 py-4">
                                ...
                                <td className="px-2 py-4">
                                    <span className={`px-2 py-1 rounded-lg text-xs font-semibold whitespace-nowrap ${bagdeColor["In Progress"]}`}>
                                        In Progress
                                    </span>
                                </td>
