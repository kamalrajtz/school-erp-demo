...
import { MOCK_BROADCASTS } from './broadcastData'
        ...
        <section>
            <div className='bg-white rounded-2xl shadow-md p-4'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:mt-8 mt-2'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        <label htmlFor='category' className='text-base font-medium text-[#808080]'>
                            Broadcast Category
                        </label>
                        <select
                            id='category'
                        ...
                        >
                            ...
                            <option value='inventory-notice'>Inventory Notice</option>
                            ...
                            {MOCK_BROADCASTS.map((item) => (
                                ...
                                >
                                    ...
                                    <td className='px-2 py-4 text-center rounded-e-lg'>
                                        <Dropdown
                                            buttonContent={
                                                <EllipsisIcon size={16} className='text-black' />
                                            }
                                        >
                                            <NavLink
                                                to={`/stationery-store-manager/broadcast/view-broadcast/${item.id}`}
            ...
            <div className='flex justify-between items-center px-4 mt-4'>
                <p className='text-sm font-medium text-[#515DEF]'>
                    Showing 1 to {MOCK_BROADCASTS.length} of {MOCK_BROADCASTS.length} entries
                </p>
