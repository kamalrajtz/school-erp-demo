export const singleTitleMapping = {
    ...
    "/front-office/admission-enquiry/add": "Add Admission Enquiry",
    ...
    "/admin/front-office/admission-enquiry/add": "Add Admission Enquiry",
    "/admin/front-office/add-admission-enquiry": "Add Admission Enquiry",
    "/admin/front-office/admission-enquiry/edit": "Edit Admission Enquiry",
    ...
    "/admin/documents/employee-documents": "Employee Documents List",
    "/admin/documents/add-employee-documents": "Add Employee Documents",
    ...
    "/admin/rbac/user-creation": "User Creation",
    "/admin/rbac/user-creation/add": "Create User",
    ...
    "/parent/student-evaluation/analytics": "Performance Analytics",
    "/student/student-evaluation/analytics": "Performance Analytics",
    ...
    "/front-office/parent-management": "Parent Database",
    "/front-office/view-student": "View Student",
    "/front-office/view-teacher": "View Teacher",
    "/front-office/view-parent": "View Parent",
    ...
    "/front-office/announcement": "Announcement List",
    ...
    "/teacher/student-allocation": "Student Allocation",
    ...
    "/teacher/star-ratings/star-of-month": "Star of the Month",
    "/teacher/star-ratings/star-of-year": "Star of the Year",
    "/teacher/star-ratings/add-ratings": "Add SOM Rating",
    ...
    "/coordinator/student-allocation": "Student Allocation",
    ...
    "/coordinator/star-ratings/star-of-month": "Star of the Month",
    "/coordinator/star-ratings/star-of-year": "Star of the Year",
    "/coordinator/star-ratings/add-ratings": "Add SOM Rating",
    ...
    "/hr/onboarding-checklist": "Onboarding Checklist",
    "/hr/attendance": "Attendance",
    "/hr/leave-management": "Leave Management",
    "/hr/training": "Training",
    "/hr/performance-review": "Performance Review",
    "/hr/reports": "Reports",
    "/hr/recruitment/interview-feedback": "Interview Feedback",
    "/hr/onboarding/offers": "Offer Letters",
    "/hr/onboarding/appointment": "Appointment Letters",
    "/hr/onboarding/joiners": "New Joiner Details",
    "/hr/onboarding/observations": "New Joinee Observation",
    "/hr/onboarding/shadow-mentor": "Shadow Mentor",
    "/hr/leave-management/policies": "Leave Policies",
    "/hr/training-records": "Training Records",
    "/hr/training-feedback": "Training Feedback",
    "/hr/performance-comparison": "Performance Comparison",
    "/hr/performance-bsc": "BSC / Audit Score",
    "/hr/performance-increment": "Increment / Promotion",
    "/hr/payroll/salary-statement": "Salary Statement",
    "/hr/payroll/payslip": "Payslip",
    "/hr/payroll/salary-advance": "Salary Advance / Loan",
    "/hr/payroll/ctc": "CTC",
    "/hr/payroll/referral-bonus": "Referral Bonus",
    "/hr/payroll/child-concession": "Employee Child Concession",
    "/hr/disciplinary": "Disciplinary Action",
    "/hr/exit": "Exit Formalities",
    "/hr/notifications": "Notifications",
    "/hr/announcements": "Announcements",
    "/hr/announcements/add": "Add Announcement",
    "/hr/announcements/view": "View Announcement",
    ...
    "/account-head/payment-vouchers": "Payment Vouchers",
    "/account-head/book-fee": "Book Fee",
    "/account-head/annual-budget": "Annual Budget",
    "/account-head/mfp": "MFP Report",
    ...
    "/principal/user-management/student-database": "Student Database",
    "/principal/user-management/employee-database": "Employee Database",
    ...
    "/principal/announcement": "Announcement List",
    "/principal/announcement/add": "Add Announcement",
    ...
    "/principal/student-allocation-approval": "Student Allocation Approval",
    ...
    "/director/student-allocation-approval": "Student Allocation Approval",
    "/director/student-allocation": "Student Allocation Approval",
...
const dynamicTitleMatchers = [
    ...
    { test: (p) => /^\/admin\/activities\/edit-cultural\/[^/]+$/.test(p), title: 'Edit Cultural Activity' },
    { test: (p) => /^\/admin\/activities\/view-sports\/[^/]+$/.test(p), title: 'Sports Activity Details' },
    { test: (p) => /^\/admin\/activities\/edit-sports\/[^/]+$/.test(p), title: 'Edit Sports Activity' },
    { test: (p) => /^\/admin\/activities\/view-competition\/[^/]+$/.test(p), title: 'Competition Activity Details' },
    { test: (p) => /^\/admin\/activities\/edit-competition\/[^/]+$/.test(p), title: 'Edit Competition Activity' },
    ...
    { test: (p) => /^\/director\/student-allocation\/allocate\/[^/]+$/.test(p), title: 'Review Student Allocation' },
    { test: (p) => /^\/director\/student-allocation\/review\/[^/]+$/.test(p), title: 'Review Student Allocation' },
    { test: (p) => /^\/principal\/student-allocation-approval\/review\/[^/]+$/.test(p), title: 'Review Student Allocation' },
    { test: (p) => /^\/teacher\/student-allocation\/allocate\/[^/]+$/.test(p), title: 'Allocate Student Section' },
    { test: (p) => /^\/coordinator\/student-allocation\/allocate\/[^/]+$/.test(p), title: 'Allocate Student Section' },
    { test: (p) => /^\/director\/activities\/view-cultural\/[^/]+$/.test(p), title: 'Cultural Activity Details' },
    { test: (p) => /^\/director\/activities\/edit-cultural\/[^/]+$/.test(p), title: 'Edit Cultural Activity' },
    { test: (p) => /^\/director\/activities\/view-sports\/[^/]+$/.test(p), title: 'Sports Activity Details' },
    { test: (p) => /^\/director\/activities\/edit-sports\/[^/]+$/.test(p), title: 'Edit Sports Activity' },
    { test: (p) => /^\/director\/activities\/view-competition\/[^/]+$/.test(p), title: 'Competition Activity Details' },
    { test: (p) => /^\/director\/activities\/edit-competition\/[^/]+$/.test(p), title: 'Edit Competition Activity' },
    { test: (p) => /^\/admin\/documents\/view-student-documents\/[^/]+$/.test(p), title: 'Student Document Details' },
    { test: (p) => /^\/admin\/documents\/edit-student-documents\/[^/]+$/.test(p), title: 'Edit Student Documents' },
    { test: (p) => /^\/admin\/documents\/edit-employee-documents\/[^/]+$/.test(p), title: 'Edit Employee Documents' },
    { test: (p) => /^\/front-office\/leave-request\/my-requests\/view\/[^/]+$/.test(p), title: 'View Leave Request Details' },
    { test: (p) => /^\/front-office\/leave-request\/received\/view\/[^/]+$/.test(p), title: 'View Received Leave Request' },
    { test: (p) => /^\/front-office\/material-gate-pass\/view\/[^/]+$/.test(p), title: 'View Material Gate Pass' },
    { test: (p) => /^\/front-office\/material-gate-pass\/edit\/[^/]+$/.test(p), title: 'Edit Material Gate Pass' },
    { test: (p) => /^\/front-office\/goods-received-pass\/view\/[^/]+$/.test(p), title: 'View Goods Received Pass' },
    ...
    { test: (p) => /^\/front-office\/announcement\/view\/[^/]+$/.test(p), title: 'View Announcement Details' },
    { test: (p) => /^\/gatekeeper-manager\/gatekeeper-broadcast-list\/view\/[^/]+$/.test(p), title: 'View Announcement Details' },
    { test: (p) => /^\/principal\/announcement\/view\/[^/]+$/.test(p), title: 'View Announcement Details' },
    ...
    { test: (p) => /^\/principal\/academic\/teacher-allocation\/allocate\/[^/]+$/.test(p), title: 'Allocate Teacher' },
    { test: (p) => /^\/principal\/academic\/teacher-allocation\/view\/[^/]+$/.test(p), title: 'View Teacher Allocation' },
    ...
    { test: (p) => /^\/teacher\/student-deliverables\/sample-questions\/view\/[^/]+$/.test(p), title: 'View Sample Questions' },
